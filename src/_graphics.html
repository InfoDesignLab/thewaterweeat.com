<section id="graphics" class="bg-gray z-index-9">
  <div class="content">
    <p data-i18n class="txt-justify">Water is precious. But not just for drinking: <b>water is food!</b><br>Thanks to the extraordinary work of scientists we know how<br>much water we need to produce the food we consume. It is<br>easy to see  that some products such as fruit and vegetables<br>are more water-friendly than others.</p>
    ...
    <div class="graph">
      <div class="item" style="margin-left: 69px">
        ...
        <div class="value" style="height: 589px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 481px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 325px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 188px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 170px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 136px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 100px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 78px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 69px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 59px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 56px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 47px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 39px;"></div>
      </div>
      <div class="item">
        <div class="ico">
        ...
        <div class="value" style="height: 28px;"></div>
      </div>
      <div class="clear"></div>
    </div>
  </div>
