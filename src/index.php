...
?>
<!DOCTYPE html>
<html i18npath="<?php echo PREFIX ?>i18n/">
  <head>
  ...
  <body class="load">
    ...
    <div class="main">
      <img src="<?php echo PREFIX ?>thumb.jpg" alt="" style="position: absolute; opacity:0; filter:alpha(opacity=0); top: 0px;left: 0px;" />
      <?php
    ...
    <script src="<?php echo PREFIX ?>js/html5/html5shim.js"></script>
    <script src="<?php echo PREFIX ?>js/html5/objectkeys.js"></script>
    <script src="<?php echo PREFIX ?>js/html5/respond.min.js"></script>
    <script src="<?php echo PREFIX ?>js/jquery/jquery.min.js"></script>
    <script src="<?php echo PREFIX ?>js/jquery/jquery.easing.js"></script>
    <script src="<?php echo PREFIX ?>js/jquery/jquery.nicescroll.js"></script>
    <script src="<?php echo PREFIX ?>js/jquery/jquery.inview.js"></script>
